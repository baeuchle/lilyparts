#(begin
  ...
  (define showRyth (if hasRyth showRyth #f))
  ...
  (ly:debug (string-append (if hasRyth "hasRyth;     " "has no Ryth; ") (if showRyth "showRyth" "show no Ryth")))
  ...
  (define suffix (append-if suffix (and (not showAlle) showRyth) "_r"))
